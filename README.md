...
This repository contains all configuration for the Strike Protocol on Ethereum. Projects wishing to interact with Strike contracts will be able to find contract addresses, ABIs and interfaces for the core Strike contracts in this repo.
